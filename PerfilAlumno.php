...
<body>
    ...
    <br><br><br>
    <div class="container perfil-postulante">
                        ...
                        <?php else : ?>
                            <?php foreach ($Proyectos as $Proyecto) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        if (empty($Proyecto['fecha_fin']) || $Proyecto['fecha_fin'] == '0000-00-00') {
                                            echo "Aun no termina";
                                        } else {
                                            echo htmlspecialchars($Proyecto['fecha_fin']);
                                        }
                                        ?>
                                    </td>
        ...
        <?php
        $EsOnoEs = "SELECT u.id_tipo_usuario FROM usuario u WHERE u.codigo_usuario = '$c'";
        $Resultado = mysqli_query($cn, $EsOnoEs);
        $EmpresaTipo = mysqli_fetch_assoc($Resultado);
        if($EmpresaTipo["id_tipo_usuario"] == 3){
        ?>
        <div class="row d-flex justify-content-center">
            <div class="col col-3 text-center">
                <div class="container">
                    <a target="_blank" href="Reportar.php?codigo=<?php echo $CodigoUsuario ?>" class="btn btn-am btn-danger">Reportar Alumno</a>
                </div>
            </div>
        </div>
        <?php } ?>
