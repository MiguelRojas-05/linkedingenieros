...
<head>
    ...
    <title>Alumno - Actualizar Foto</title>
...
?>
    ...
    <fieldset class="grupito">
        ...
        <br>
        <form action="ProcesoFotoPerfilAlumno.php" method="post" enctype="multipart/form-data">
            <table align="center">
                <tr>
    ...
    <table width="440">
        <tr>
            <td colspan="2" align="right">
                <a class="btn btn-sm btn-secondary" href="FotoPerfilAlumno.php" style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
                    Regresar
                </a>
            </td>
        </tr>
