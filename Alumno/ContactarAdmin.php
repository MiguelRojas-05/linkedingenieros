...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query_insert = "INSERT INTO mensaje (codigo_emisor, descripción, id_tipo_usuario) VALUES('$c', '$descripcion', 1)";
    ...
    <div class="container" style="margin-top: 120px;">
        ...
        <div class="container m-2">
            <form class="row d-flex" method="post" action="ContactarAdmin.php">
                ...
                <button type="submit" class="ms-4 bg-primary col col-1 btn text-white">
