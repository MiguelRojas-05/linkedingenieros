...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    Header('Location: ConversacionSoporteEmpresa.php?codigo='. urlencode($c));
    exit();
}
?>
...
<div class="container text-center" style="margin-top: 100px;">
    <a href="ContactoSoporte.php" class="btn btn-secondary btn-sm mb-1">Regresar a conversaciones</a>
            ...
            <div class="row m-3 d-flex justify-content-center">
                <div class="col">
                    ...
                    $sql = "SELECT m.id, 
                            ...
                            e.razon_social
                            FROM mensaje m
                            INNER JOIN empresa e ON m.codigo_emisor = e.codigo
                    ...
                    ?>
                        ...
                        <?php } else if ($r["id_tipo_usuario"] == 3) { ?>
                            <div class="row text-start pe-4">
                                <span class="fw-bold"><?php echo $r["razon_social"]; ?></span>
        ...
        <div class="row d-flex justify-content-center m-2">
            <form class="col col-5" method="post" action="ConversacionSoporteEmpresa.php">
