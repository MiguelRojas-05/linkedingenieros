...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    Header('Location: ConversacionSoporteDocente.php?codigo='. urlencode($c));
    exit();
}
?>
...
<div class="container text-center" style="margin-top: 100px;">
    <a href="ContactoSoporte.php" class="btn btn-secondary btn-sm mb-1">Regresar a conversaciones</a>
            ...
            <div class="row m-3 d-flex justify-content-center">
                <div class="col">
                    ...
                    $sql = "SELECT m.id, 
                            ...
                            m.id_tipo_usuario, 
                            CONCAT(d.nombre, ' ', d.a_paterno, ' ', d.a_materno) AS nombres
                            FROM mensaje m
                            INNER JOIN docente d ON m.codigo_emisor = d.codigo
                    ...
                    ?>
                        ...
                        <?php } else if ($r["id_tipo_usuario"] == 2) { ?>
        ...
        <div class="row d-flex justify-content-center m-2">
            <form class="col col-5" method="post" action="ConversacionSoporteDocente.php">
