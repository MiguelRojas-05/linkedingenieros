...
<head>
    ...
    <title>Docente - Actualizar Foto</title>
    ...
    <fieldset class="grupito">
        ...
        <center>
            <h6 style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
                Por favor, ingrese su nueva foto de perfil.
            </h6>
        </center>
        <br>
        <form action="ProcesoFotoPerfilDocente.php" method="post" enctype="multipart/form-data">
            <table align="center">
                <tr>
    ...
    <table width="440">
        <tr>
            <td colspan="2" align="right">
                <a class="btn btn-sm btn-secondary" href="FotoPerfilDocente.php" style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
                    Regresar
                </a>
            </td>
        </tr>
