...
<head>
    ...
    <title>Docente - Foto de Perfil</title>
...
?>
    ...
    if (!empty($RutaImagen)) {
        ...
        echo '<div class="a-cv">
                <a href="ActualizarFotoPerfilDocente.php">Actualizar foto de Perfil</a>
            </div>';
        ...
        <fieldset class="grupito">
            ...
            <center>
                <h6 style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
                    Por favor, registre su foto de Perfil.
                </h6>
            </center>
            <br>
