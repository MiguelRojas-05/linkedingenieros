...
if (isset($_FILES["foto"]) && $_FILES["foto"]["error"] == 0) {
    $ImagenEmpresa = $_FILES["foto"]["tmp_name"];
    ...
    if ($extension == "png" || $extension == "jpg") {
        // Guardar la imagen o foto de perfil de las empresas en la carpeta FotoPerfil/Empresas
        // La imagen o foto se guarda automáticamente con el código de la empresa
        $destino = "../FotoPerfil/Empresas/" . $c . ".jpg";

        if (move_uploaded_file($ImagenEmpresa, $destino)) {
                // Redireccionar a FotoPerfilEmpresa.php
            header('Location: FotoPerfilEmpresa.php');
